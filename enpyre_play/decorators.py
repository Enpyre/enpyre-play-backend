...
def durable(func):
    ...
    def wrapper(*args, **kwargs):
        durability_checking_enabled = not getattr(settings, 'DISABLE_DURABILITY_CHECKING', False)
        ...
        if durability_checking_enabled and _db_may_have_uncommitted_work():
            ...
            raise utils.ProgrammingError('A durable function must not leave work uncommitted.')
